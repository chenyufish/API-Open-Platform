package com.fishman.project.constant;
...
public interface EmailConstant {
     ...
     * 电子邮件标题
     */
    String EMAIL_TITLE = "fishman-API 接口开放平台";

    /**
     * 电子邮件标题英语
     */
    String EMAIL_TITLE_ENGLISH = "fishman-API Open Interface Platform";

    /**
     * 平台负责人
     */
    String PLATFORM_RESPONSIBLE_PERSON = "fishman工作室";
