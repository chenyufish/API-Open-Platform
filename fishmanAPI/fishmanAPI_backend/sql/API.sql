-- 创建库
create database if not exists fishmanapi;
ALTER DATABASE fishmanapi CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- 切换库
use fishmanapi;
-- 修改数据表的字符集为UTF-8
ALTER TABLE fishmanapi.user CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- 用户表
create table if not exists fishmanapi.user
(
...
-- 每日签到表
create table if not exists fishmanapi.daily_check_in
(
    id          bigint auto_increment comment 'id' primary key,
...
-- 接口信息
create table if not exists fishmanapi.interface_info
(
    id             bigint auto_increment comment 'id' primary key,
...
-- 产品信息
create table if not exists fishmanapi.product_info
(
    id             bigint auto_increment comment 'id' primary key,
...
# 产品订单
create table if not exists fishmanapi.product_order
(
    id             bigint auto_increment comment 'id' primary key,
...
#付款信息
create table if not exists fishmanapi.payment_info
(
    id             bigint auto_increment comment 'id' primary key,
...
-- 用户接口调用表
create table if not exists fishmanapi.user_interface_invoke
(
    id           bigint auto_increment comment 'id' primary key,
...
-- 充值活动表
create table if not exists fishmanapi.recharge_activity
(
    id         bigint auto_increment comment 'id' primary key,
...
INSERT INTO fishmanapi.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695338876708544514, '100坤币', '增加100坤币到钱包', 1691069533871013889, 1, 100, 'RECHARGEACTIVITY', 1, null, '2023-08-26 15:34:20', '2023-08-28 12:58:30', 0);
INSERT INTO fishmanapi.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695773972037839073, '9999坤币', '增加9999坤币到钱包', 1691069533871013889, 699, 9999, 'RECHARGE', 1, '2023-08-28 13:01:34', '2023-08-27 20:35:34', '2023-08-27 20:41:29', 0);
INSERT INTO fishmanapi.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695776766919888897, '1000坤币', '增加1000坤币到钱包', 1691069533871013889, 99, 1000, 'RECHARGE', 1, null, '2023-08-27 20:34:21', '2023-08-27 20:34:21', 0);
INSERT INTO fishmanapi.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695777072030339073, '3000坤币', '增加3000坤币到钱包', 1691069533871013889, 199, 3000, 'RECHARGE', 1, null, '2023-08-27 20:35:34', '2023-08-27 20:41:29', 0);
INSERT INTO fishmanapi.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695777203236556802, '15999坤币', '增加15999坤币到钱包', 1691069533871013889, 888, 15999, 'RECHARGE', 1, null, '2023-08-27 20:36:05', '2023-08-28 13:02:25', 0);
INSERT INTO fishmanapi.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695778320091631617, '18999坤币', '增加18999坤币到钱包', 1691069533871013889, 999, 18999, 'RECHARGE', 1, null, '2023-08-27 20:40:32', '2023-08-28 13:02:42', 0);
INSERT INTO fishmanapi.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1697087470134259713, '10坤币', '签到获取', 1692848556158709762, 0, 10, 'RECHARGE', 0, null, '2023-08-31 11:22:37', '2023-08-31 11:22:37', 1);

insert into fishmanapi.interface_info(`id`, `name`, `url`, `userId`, `method`, `requestParams`, `reduceScore`, `requestExample`,
