...
import {getInterfaceInfoByIdUsingGet, invokeInterfaceUsingPost} from "@/services/fishmanAPI_backend/interfaceInfoController";
...
const InterfaceInfo: React.FC = () => {
    ...
    const docUrl = process.env.NODE_ENV === 'http://localhost:8080'
